...
def TargetWeb(url):
    ...
    time.sleep(10)
    try:
        browser.find_element(By.CSS_SELECTOR,"body > div.dui-modal-mask.dui-modal-mask-visible.dui-modal-mask-display > div > div.dui-modal-footer > button.dui-button.dui-modal-footer-ok.dui-button-type-primary.dui-button-size-default > div").click()
    except:
        print("失败！定位不到‘确认’按钮")
