...
class SyntacticAnalyzer:
    ...
    sementic_analyzer_ = SemanticAnalyzer()
    ...
    # def split_string(self, string: str, pattern: str) -> list[str]:
    #     res = []
    #     if string == "":
    #         return res
    #     # Add the pattern at the end of the string to facilitate the last segment extraction
    #     strs = string + pattern
    ...
    #         temp = strs[:pos]
    #         res.append(temp)
    #         # Remove the already split string and continue splitting in the remaining string
    #         strs = strs[pos + len(pattern) :]
    #         pos = strs.find(pattern)
    ...
    def GenNormalFamilySet(self):
        ...
        # ]  # TODO：寻找0号产生式的LR0项目，作为初始项目集，这里取集合的第一项并不符合要求要修改。
    ...
    def StartAnalize(self, code_filename):
        ...
        self.grammar_symbol_info_stack_ = [GrammarSymbolInfo(symbol_name="PROG")]  # 初始的文法符号属性
