    ...
    case WM_COMMAND:
    {
        ...
        case IDM_ADD:
        {
            ...
            hTextBox3 = CreateWindowW(L"EDIT", L"", WS_BORDER | WS_CHILD | WS_VISIBLE,
                                      800, 150, 50, 20, hWnd, NULL, hInst, NULL);
